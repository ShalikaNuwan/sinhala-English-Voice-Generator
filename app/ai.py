            ...
            input=[
                {
                    ...
                    "content": (
                        ...
                        "- narration_text is only the words to be spoken. No stage directions, no bracketed or "
            ...
            input=[
                {
                    ...
                    "content": (
                        ...
                        "reordering, and an ellipsis or dash used for pacing are style, not meaning. Pass only when "
